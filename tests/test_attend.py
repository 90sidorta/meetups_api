...
def test_attend_meetup(
    authorized_client, test_load_users, test_load_meetups, test_load_attends
):
...
def test_attend_meetup_unauthorized(
    client, test_load_users, test_load_meetups, test_load_attends
):
...
def test_cancel_attend_nonexistent(
    authorized_client, test_load_users, test_load_meetups, test_load_attends
):
...
def test_cancel_attend_unattended(
    authorized_client, test_load_users, test_load_meetups, test_load_attends
):
